    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6 px-0 d-none d-sm-block">
          <iframe src="https://giphy.com/embed/kEy7Hw1gL2DGo" width="720" height="720" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
        </div>
        <div class="col-sm-6">
          <br><br><br>
          <h3>Login as admin</h3>
          <form action="config/quizwadloginadmin.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
