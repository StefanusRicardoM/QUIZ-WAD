    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6 text-black">
                ...
                <form action="config/quizwadsignup.php" method="post" enctype="multipart/form-data">
                    <h3>Registrasi</h3> <br>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Email<h8 class=text-danger>*</h8></label>
                        <input type="email" class="form-control" name="emailcustomer" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" name="passwordcustomer" id="exampleInputPassword1" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <p>Anda sudah punya akun?  <a href="quizwadindex.php?page=Logincustomer" class="text-primary">Login</a></p>
                </form>
                </div>
        </div>
    </div>
