...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mb-3" style="margin-top:30px;">
      <h2 class="text-light">Tambah Menu</h2>
      <br>
      <section id=form>
        <form action="config/quizwadaddmenu.php" method="post" enctype="multipart/form-data">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="number" id="quantity" class="form-control" name="harga">
          </div>
          <div class="mb-3">
